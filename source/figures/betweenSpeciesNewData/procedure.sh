...
#for file in /data2/rivasas2/limbs/trinity/bat/blast/bat*.orthologs.txt; do ln -s $file .; done
#ln -s /data2/rivasas2/limbs/trinity/bat/blast/getAllOrthologs.py .
#ln -s /data2/rivasas2/limbs/trinity/bat/blast/all.orthologs.txt .
...
for level in "25" "[a-z]5"; do
	...
	nameCon=conserved_${limb}_${stage}${levelsName[$level]}"%"
	nameDiv=divergent_${limb}_${stage}${levelsName[${levels[$level]}]}"%"
